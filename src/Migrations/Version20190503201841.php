 ...
 */
final class Version20190503201841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budget ADD active INT NOT NULL, CHANGE account_id account_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budget DROP active, CHANGE account_id account_id INT DEFAULT NULL');
